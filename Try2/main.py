...
def register_custom_env():
    register(
        id='TankLevel-v0',  # Choose a unique ID for your environment
        entry_point=TankLevel,  # Specify the module and class name for your environment
        max_episode_steps=200  # Set the maximum number of steps per episode
    )
register_custom_env()
